...
(function () {
   ...
   var _vehicleDataIds = new Array('rpm', 'vss', 'load_pct', 'climateall', 'climatedriver', 'climatefrontpassenger', 'climatebehinddriver', 'climatebehindpassenger', 'parksensors-front', 'parksensors-rear', 'lights-fog-front', 'lights-fog-rear', 'lights-signal-right', 'lights-signal-left', 'lights-signal-warn', 'lights-hibeam', 'lights-parking', 'lights-head', 'lights-head', 'destination-reached', 'destination-changed', 'destination-cancelled', 'parksensors-front', 'parksensors-rear', 'gear', 'tripcomputer', 'tirepressure', 'wiper', 'engineoil', 'door', 'interfaces', 'window', 'seatdriver', 'seatfrontpassenger', 'seatbehinddriver', 'seatbehindpassenger', 'shift');
